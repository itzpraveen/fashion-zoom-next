      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { city: 'Kochi', date: 'Dates announcing soon', img: '/assets/showcase/webp/frame-65.webp' },
              { city: 'Calicut', date: 'Dates announcing soon', img: '/assets/showcase/webp/poster-a4-6.webp' },
              { city: 'Trivandrum', date: 'Dates announcing soon', img: '/assets/showcase/webp/frame-66.webp' },
            ].map((e, i) => (
              <Reveal key={e.city} className="rounded-lg overflow-hidden border shadow-sm bg-white">
                <Image src={e.img} alt={`Fashion Zoom upcoming show — ${e.city} poster`} width={1080} height={1440} sizes="(min-width: 1024px) 33vw, 100vw" className="w-full h-auto" />
