export const locales = {
  en: {
    ...
    sections: {
      ...
      shows: 'Fashion Shows',
      academy: 'Modeling Academy',
      gallery: 'Gallery',
      contact: 'Contact Us',
      why: 'Why Fashion Zoom',
  ...
  ml: {
    ...
    hero: {
      ...
      ctaPrimary: 'ഞങ്ങളുടെ അക്കാദമിയിൽ ചേരുക',
      ctaSecondary: 'ഫാഷൻ ഷോകൾ കാണുക'
    },
    sections: {
      about: 'ഫാഷൻ സൂം കുറിച്ച്',
      shows: 'ഫാഷൻ ഷോകൾ',
      academy: 'മോഡലിംഗ് അക്കാദമി',
      gallery: 'ഗാലറി',
      contact: 'ബന്ധപ്പെടുക',
      why: 'എന്തുകൊണ്ട് ഫാഷൻ സൂം',
      faq: 'അടിക്കടി ചോദിക്കുന്ന ചോദ്യങ്ങൾ',
      magazine: 'മാഗസിന്‍'
    },
  },
}
